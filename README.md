...
- **🏢 OBJ to Octree Conversion** - Convert 3D building models (OBJ format) with materials (MTL) into Radiance octree format
- **☀️ Sky File Generation** - Create accurate sky models for different times, dates, and locations using Radiance's gensky
- **👁️ View Generation** - Generate view parameter files for interior and exterior building analysis  
- **⚡ Parallel Processing** - Built-in parallel execution for computationally intensive operations
- **🎨 Material Processing** - Automatic conversion of MTL materials to Radiance material descriptions
- **📅 Seasonal Analysis** - Pre-configured workflows for solstice and seasonal daylight studies
...
│   ├── winter_solstice_sunlight_exposure.py
│   └── summer_solstice_shd_analysis.py
│
├── 🧪 tests/                       # Test suite
│   ├── test_geometric_calculations.py
│   └── test_sky_generator.py
│
└── 📂 intermediates/               # Processing files
...
- **[pyradiance](https://github.com/LBNL-ETA/pyradiance)** ≥1.1.5 - Official Python interface to Radiance
- **[open3d](https://open3d.org/)** ≥0.19.0 - 3D data processing and visualization  
- **[ifcopenshell](https://ifcopenshell.org/)** ≥0.8.3 - Building Information Modeling (BIM) support
- **[numpy](https://numpy.org/)** ≥2.3.2 - Numerical computing
- **[pandas](https://pandas.pydata.org/)** ≥2.3.1 - Data analysis and manipulation
...
- 📋 **Issues**: [GitHub Issues](https://github.com/vincentlogarzo/archilume/issues)
- 📚 **Examples**: Check the `examples/` directory  
- 🧪 **Tests**: Review `tests/` for API usage patterns

---

<div align="center">
<strong>🏛️ Archilume - Architectural Lighting Made Simple</strong>
</div>